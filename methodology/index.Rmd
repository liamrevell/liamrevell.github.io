...
Though plot suggests that perhaps around 25-30% of the population in Texas has already been infected, users should keep in mind that 
...
iceberg.plot(data=Data,
	state="Washington",
	ifr=c(0.015,0.01,0.007,0.006,0.006,0.006,0.006),
	las=1,cex.axis=0.8,cex.lab=0.9,span=c(0.15,0.3),
	window=3)
```
...
The R package [*covid19.Explorer*](https://github.com/liamrevell/covid19.Explorer/) and the website [covid19-explorer.org](http://covid19-explorer.org) were 
...
the [covid19-explorer.org website](http://covid19-explorer.org) or the R package.
