...
Figure 5 gives this analysis for the U.S. state of Washington, in which we assumed the same IFR model through time as was used for
Figures 1, 2, and 3. Daily observed cases are smoothed using a 3-day moving average.

```{r, echo=FALSE, results='hide', message=FALSE, warning=FALSE, fig.width=12, fig.height=8, units="in", dpi=150, fig.cap="**Figure 5**: Iceberg plot showing the confirmed daily new infections (above the waterline) and estimated unobserved infections (below it) for the U.S. state of Washington."}
iceberg.plot(data=Data,
	state="Washington",
	ifr=c(0.015,0.01,0.007,0.006,0.006,0.006,0.006),
	las=1,cex.axis=0.8,cex.lab=0.9,span=0.2,window=3)
```
...
```{r, echo=FALSE, results='hide', message=FALSE, warning=FALSE, fig.width=12, fig.height=8, units="in", dpi=150, fig.cap="**Figure 6**: Daily estimated infections separated by state."}
infections.by.state(data=Data,
	ifr=c(0.015,0.01,0.007,0.006,0.006,0.006,0.006),
	las=1,cex.axis=0.8,cex.lab=0.9,span=0.2)
```
...
```{r, echo=FALSE, results='hide', message=FALSE, warning=FALSE, fig.width=12, fig.height=10, units="in", dpi=150, fig.cap="**Figure 7**: a) Confirmed COVID-19 deaths. b) A corresponding plausible range of daily COVID-19 infections, under our model."}
...
The following graph (Figure 8) shows a comparison of daily deaths and estimated infections in Michigan and Ohio.

```{r, echo=FALSE, results='hide', message=FALSE, warning=FALSE, fig.width=12, fig.height=10, units="in", dpi=150, fig.cap="**Figure 8**: Daily confirmed COVID-19 deaths (a) or estimated infections (b) in the U.S. states of Michigan vs. Ohio."}
par(lwd=2)
...
```{r, echo=FALSE, results='hide', message=FALSE, warning=FALSE, fig.width=12, fig.height=10, units="in", dpi=150, fig.cap="**Figure 9**: a) Weekly confirmed COVID-19 deaths subdivided by age. b) Weekly COVID deaths (red) and deaths by other causes (blue) for all ages."}
...
for only about 0.4% of all deaths (Figure 10).

```{r, echo=FALSE, results='hide', message=FALSE, warning=FALSE, fig.width=12, fig.height=10, units="in", dpi=150, fig.cap="**Figure 10**: a) Cumulative confirmed COVID-19 deaths for children <15. b) Cumulative COVID deaths (red) and deaths by other causes (blue) for all ages."}
...
By contrast, COVID-19 accounts for nearly 12% of all deaths of U.S. persons aged &ge;75 years of age (Figure 11).

```{r, echo=FALSE, results='hide', message=FALSE, warning=FALSE, fig.width=12, fig.height=10, units="in", dpi=150, fig.cap="**Figure 11**: a) Cumulative confirmed COVID-19 deaths for U.S. adults 75 years of age and older. b) Cumulative COVID deaths (red) and deaths by other causes (blue) for all ages."}
...
```{r, echo=FALSE, results='hide', message=FALSE, warning=FALSE, fig.width=12, fig.height=10, units="in", dpi=150, fig.cap="**Figure 12**: Weekly (a) and cumulative (b) % deaths above normal for the U.S. state of Michigan."}
...
```{r, echo=FALSE, results='hide', message=FALSE, warning=FALSE, fig.width=12, fig.height=10, units="in", dpi=150, fig.cap="**Figure 13**: Weekly (a) and cumulative percent (b) deaths above normal for adults aged 25-44 in Florida during 2020."}
