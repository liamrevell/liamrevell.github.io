...
This plot suggests that perhaps around 17% of the population in Texas has already been infected; however, users should keep in mind that 
this is entirely dependent on how we *decided* to model IFR through time. To see this, let's take the same state (Texas) and imagine 
(perhaps relatively naively) a *constant* IFR of 0.5%, rather than one that declines through time.

```{r, echo=FALSE, results='hide', message=FALSE, warning=FALSE, fig.width=12, fig.height=10, units="in", dpi=150, fig.cap="**Figure 4**: The same analysis as Figure 3, but assuming a constant IFR of 0.5%."}
infection.estimator(data=Data,
	state="Texas",
	ifr=0.005,
	las=1,cex.axis=0.8,cex.lab=0.9,
...
progression of infection more apparent in the graph. The results can be seen in Figure 5.

```{r, echo=FALSE, results='hide', message=FALSE, warning=FALSE, fig.width=12, fig.height=8, units="in", dpi=150, fig.cap="**Figure 5**: Cumulative estimated infections separated by state."}
...
```{r, echo=FALSE, results='hide', message=FALSE, warning=FALSE, fig.width=12, fig.height=10, units="in", dpi=150, fig.cap="**Figure 6**: a) Confirmed COVID-19 deaths. b) A corresponding plausible range of daily COVID-19 infections, under our model."}
...
the mean number of daily or cumulative infections in Figure 6 *looks* like a confidence band, it would only be valid to consider
...
The following graph (Figure 7) shows a comparison of daily deaths and estimated infections in Michigan and Ohio.

```{r, echo=FALSE, results='hide', message=FALSE, warning=FALSE, fig.width=12, fig.height=10, units="in", dpi=150, fig.cap="**Figure 7**: Daily confirmed COVID-19 deaths (a) or estimated infections (b) in the U.S. states of Michigan vs. Ohio."}
par(lwd=2)
...
if done on a per-capita basis (e.g., infections / 1M population), as shown in Figure 7.
...
distribution of COVID-19 deaths by age & sex (Figure 8).

```{r, echo=FALSE, results='hide', message=FALSE, warning=FALSE, fig.width=12, fig.height=10, units="in", dpi=150, fig.cap="**Figure 8**: a) Weekly confirmed COVID-19 deaths subdivided by age. b) Weekly COVID deaths (red) and deaths by other causes (blue) for all ages."}
...
for only about 0.4% of all deaths (Figure 9).

```{r, echo=FALSE, results='hide', message=FALSE, warning=FALSE, fig.width=12, fig.height=10, units="in", dpi=150, fig.cap="**Figure 9**: a) Cumulative confirmed COVID-19 deaths for children <15. b) Cumulative COVID deaths (red) and deaths by other causes (blue) for all ages."}
...
By contrast, COVID-19 accounts for >10% of all deaths of U.S. persons aged &ge;75 years of age (Figure 10).

```{r, echo=FALSE, results='hide', message=FALSE, warning=FALSE, fig.width=12, fig.height=10, units="in", dpi=150, fig.cap="**Figure 10**: a) Cumulative confirmed COVID-19 deaths for U.S. adults 75 years of age and older. b) Cumulative COVID deaths (red) and deaths by other causes (blue) for all ages."}
...
Note the difference between the axes of Figure 9 and Figure 10. In the former deaths are shown per 1M population, whereas the latter reports 
...
[website](http://covid19-explorer.org) allows users to explore [excess mortality](https://en.wikipedia.org/wiki/Mortality_displacement)
...
<br>
Figure 11 shows the weekly and cumulative percent deaths above normal for the U.S. state of Michigan.

```{r, echo=FALSE, results='hide', message=FALSE, warning=FALSE, fig.width=12, fig.height=10, units="in", dpi=150, fig.cap="**Figure 11**: Weekly (a) and cumulative (b) % deaths above normal for the U.S. state of Michigan."}
...
state (i.e., age-stratified population sizes), we show *only* excess deaths and percent deaths above normal. Figure 12 gives an example for
persons aged 25-44 from the U.S. state of Florida.

```{r, echo=FALSE, results='hide', message=FALSE, warning=FALSE, fig.width=12, fig.height=10, units="in", dpi=150, fig.cap="**Figure 12**: Weekly (a) and cumulative percent (b) deaths above normal for adults aged 25-44 in Florida during 2020."}
