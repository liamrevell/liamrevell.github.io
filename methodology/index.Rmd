...
[covid19-explorer.org](https://covid19-explorer.org).
...
reasons that we elaborate below, confirmed COVID-19 cases underestimate the true number of infections, usually by a substantial
...
Though plot suggests that perhaps around 20% of the population in Texas has already been infected, users should keep in mind that 
...
By contrast, COVID-19 accounts for nearly 12% of all deaths of U.S. persons aged &ge;75 years of age (Figure 10).
