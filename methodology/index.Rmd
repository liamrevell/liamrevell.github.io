...
Though plot suggests that perhaps around 25% of the population in Texas has already been infected, users should keep in mind that 
...
```{r, echo=FALSE, results='hide', message=FALSE, warning=FALSE, fig.width=12, fig.height=10, units="in", dpi=150, fig.cap="**Figure 8**: Daily confirmed COVID-19 deaths (a) or estimated infections (b) in the U.S. states of California vs. Florida."}
par(lwd=2)
